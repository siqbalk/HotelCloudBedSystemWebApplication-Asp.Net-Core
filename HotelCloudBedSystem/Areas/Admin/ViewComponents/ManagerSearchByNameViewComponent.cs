...
{
    public class ManagerSearchByNameViewComponent:ViewComponent
    {
        private IAppUserIEFRepository _repository;
        private UserManager<AppUser> _userManager;

        public ManagerSearchByNameViewComponent(IAppUserIEFRepository repository, UserManager<AppUser> userManager)
        {
        ...
        private Task<AddUserViewModel> GetItemsAsync()
        {
            ...
            var result = _userManager.GetUsersInRoleAsync("Manager").Result;
            if (result != null)
            {
