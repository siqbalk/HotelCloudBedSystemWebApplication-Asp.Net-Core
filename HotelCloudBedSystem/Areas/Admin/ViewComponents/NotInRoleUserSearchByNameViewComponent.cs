...
{
    public class NotInRoleUserSearchByNameViewComponent:ViewComponent
    {
        private IAppUserIEFRepository _repository;
        private UserManager<AppUser> _userManager;

        public NotInRoleUserSearchByNameViewComponent(IAppUserIEFRepository repository, UserManager<AppUser> userManager)
        {
