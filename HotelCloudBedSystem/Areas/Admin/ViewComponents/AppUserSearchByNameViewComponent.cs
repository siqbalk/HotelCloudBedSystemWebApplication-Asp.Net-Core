...
{
    public class AppUserSearchByNameViewComponent:ViewComponent
    {
        private IAppUserIEFRepository _repository;
        private UserManager<AppUser> _userManager;

        public AppUserSearchByNameViewComponent(IAppUserIEFRepository repository, UserManager<AppUser> userManager)
        {
        ...
        private Task<AddUserViewModel> GetItemsAsync()
        {
            ...
            var result = _userManager.GetUsersInRoleAsync("User").Result;
            if (result != null)
            {
