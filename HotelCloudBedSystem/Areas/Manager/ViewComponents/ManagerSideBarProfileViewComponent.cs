...
{
    public class ManagerSideBarProfileViewComponent:ViewComponent
    {
        private UserManager<AppUser> _userManager;
        private RoleManager<AppRole> _roleManager;

        public ManagerSideBarProfileViewComponent(UserManager<AppUser> userManager, RoleManager<AppRole> roleManager)
        {
