...
{
    public class WinterHotelViewComponent : ViewComponent
    {
        private HotelCloudDbContext _context;
        public WinterHotelViewComponent(HotelCloudDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var hotels =  _context.hotels.Where(p => p.HotelCity == "Lahore" || p.HotelCity == "Karachi"
              ...
              ||p.HotelCity =="Nawshehra" || p.HotelCity =="Islamabad" || p.HotelCity =="Abbotabad")
                .ToList();
